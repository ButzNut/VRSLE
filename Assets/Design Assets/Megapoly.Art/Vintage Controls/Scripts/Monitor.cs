...
public class Monitor : MonoBehaviour
{
    ...
    void Update()
    {
        if (on)
        {
            ...
            // adapted to URP pipeline
            rend.material.SetColor("_BaseColor", new Color(1.517f, 1.517f, 1.517f, 1f));
            rend.material.SetTextureOffset("_BaseMap", new Vector2(0.25f * (screenImage % 4), 0.25f * (screenImage / 4)));
        }
        else
        {
